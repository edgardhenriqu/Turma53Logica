...
contabiliza e apresente também quantas foram as ocorrências da maior população.
...
*/
	...
	funcao inicio()
	{
		...
		media=s/10
		escreva("nA média dos valores lançados é :",media)
		escreva("\nA maoir pontuação ocorreu ",cont, " vezes")
	}
}
/* $$$ Portugol Studio $$$ 
 * 
